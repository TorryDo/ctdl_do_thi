...
enum menuCode
{ 
	ADD_VERTEX_MENU,ADD_EDGE_MENU, RENAME_VERTEX_MENU, DELETEVE_MENU, MOVEVE_MENU, CLEAN_GRAPH_MENU,HELP_MENU, 
	OPEN_MENU, AGLO_MENU, QUIT_MENU, LOAD_MENU, SAVE_MENU,
